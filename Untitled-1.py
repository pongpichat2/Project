...
def Calchoice():
    ...
    for z in range(1, len(asw)):
        if text[z] == text[z-1]:#ตัวอักษรซ้ำกันน
            ...
            #-------------กรณีเป็นอักษรพิเศษ และ ตัวเลข--------------#(ทำเพิ่ม)
            else:
                ...
                #-------------กรณีเป็นอักษรพิเศษ --------------#
                #-------------ตรวจว่า Z และ Z-1 อยู่ในชุด Array เดียวกันไหม --------------#
                #-------------ถ้าใช่ คำนวน   --------------#
                #-------------ถ้าไม่ ตรวจว่า Z-1 อยู่ใน Array ไหน ถ้าอยู่ใน Array TextNonShift timetext+Shif --------------#
                #------------- Z-1 อยู่ใน Array ไหน ถ้าอยู่ใน Array TextOnShift timetext+Shif --------------#
